        ...
        >
          {intro && (
            <RichText
              ...
              enableGutter={false}
              className="
      [&_h3]:text-2xl [&_h3]:md:text-3xl [&_h3]:font-semibold [&_h3]:text-black [&_h2]:text-3xl [&_h2]:md:text-3xl [&_h2]:font-semibold [&_h2]:text-black [&_h2]:mb-4 [&_h3]:mb-4 [&_h2]:break-words [&_h2]:max-w-full [&_h3]:px-4 [&_h2]:mx-auto [&_p]:text-black [&_p]:text-lg [&_p]:font-medium [&_p]:leading-relaxed
    "
            />
          )}        </motion.div>
