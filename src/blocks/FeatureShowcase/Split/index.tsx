        ...
        >
          {intro && (
            <RichText
              ...
              enableGutter={false}
              className="
      [&_h3]:text-2xl [&_h3]:md:text-3xl [&_h3]:font-semibold [&_h3]:text-black [&_h3]:leading-tight [&_h3]:mb-4 [&_h3]:break-words [&_h3]:max-w-full [&_h3]:px-4 [&_h3]:mx-auto [&_p]:text-black [&_p]:text-lg [&_p]:font-medium [&_p]:leading-relaxed
    "
            />
          )}        </motion.div>
