        ...
        >
          {intro && (
            <RichText
              ...
              enableGutter={false}
              className="
      [&_h2]:type-headline-2 [&_h2]:text-type-heading [&_h2]:mb-6 [&_h2]:break-words [&_h2]:max-w-full [&_p]:text-type-body [&_p]:type-body-md md:[&_p]:type-body-xl [&_p]:leading-relaxed
    "
            />
          )}        </motion.div>
