  ...
  return (
    <section ref={sectionRef} className="relative md:py-24 md:space-y-8 overflow-hidden bg-slate-100 dark:bg-slate-900">
      <div className="mx-auto w-full max-w-7xl space-y-8 px-6 md:space-y-12">
        ...
        >
          {intro && <RichText data={intro} enableGutter={false} className="flex flex-col md:flex-row gap-8 [&_h2]:flex-1 [&_h3]:flex-1 [&_p]:flex-1 [&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:font-semibold [&_h2]:text-type-heading [&_h2]:mb-4 md:[&_h2]:mb-0 [&_h2]:break-words [&_h2]:leading-tight [&_h2]:max-w-full [&_h2]:px-4 [&_h2]:mx-auto [&_h3]:text-2xl [&_h3]:md:text-3xl [&_h3]:font-semibold [&_h3]:text-type-heading [&_h3]:mb-4 md:[&_h3]:mb-0 [&_h3]:break-words [&_h3]:leading-tight [&_h3]:max-w-full [&_h3]:px-4 [&_h3]:mx-auto [&_p]:text-type-body [&_p]:type-body-xl [&_p]:font-medium [&_p]:leading-relaxed" />}
        </motion.div>
      </div>
