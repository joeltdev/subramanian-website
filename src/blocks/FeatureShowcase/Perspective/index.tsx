  ...
  return (
    <section ref={sectionRef} className="relative md:py-24 md:space-y-8 overflow-hidden" data-section-theme="dark">
      <div className="mx-auto w-full max-w-7xl space-y-8 px-6 md:space-y-12">
        ...
        >
                    {intro && <RichText data={intro} enableGutter={false} className="flex flex-col gap-6 md:gap-8 [&_h2]:type-headline-2 md:[&_h2]:type-headline-1 [&_h2]:text-type-heading [&_h2]:mb-0 [&_h2]:break-words [&_h2]:leading-tight [&_h2]:max-w-full [&_h3]:type-headline-2 md:[&_h3]:type-headline-1 [&_h3]:text-type-heading [&_h3]:mb-0 [&_h3]:break-words [&_h3]:leading-tight [&_h3]:max-w-full [&_p]:text-type-body [&_p]:type-body-lg md:[&_p]:type-body-xl [&_p]:font-medium [&_p]:leading-relaxed" />}
        </motion.div>
      </div>
            ...
            {items.map(({ id, icon, richText }) => {
              ...
              return (
                <div key={id} className="space-y-3 bg-muted shadow-xs rounded-none px-6 py-8">
                  ...
                  {richText && <RichText data={richText} enableGutter={false} className="space-y-4 md:space-y-2 [&_h4]:text-type-heading [&_h4]:type-body-sm [&_h4]:font-bold [&_h3]:text-type-heading [&_h3]:text-type-title-md [&_p]:type-body-sm [&_p]:text-type-body [&_p]:leading-relaxed" />}
                </div>
              )
            })}
          </motion.div>
