        ...
        {intro_n_a && (
          <div className="mb-12 md:mb-20 flex flex-col items-center justify-center text-center w-full">
            <RichText
              ...
              enableGutter={false}
              enableProse={false}
              className="max-w-4xl mx-auto flex flex-col items-center w-full [&_h2]:text-3xl md:[&_h2]:text-5xl lg:[&_h2]:text-6xl [&_h2]:font-bold [&_h2]:text-type-heading [&_h2]:mb-8 [&_h2]:text-center [&_h2]:w-full [&_p]:type-body-xl [&_p]:text-type-secondary [&_p]:max-w-2xl [&_p]:mx-auto [&_p]:text-center [&_p]:w-full"
            />
          </div>
        )}
