          ...
          <div className="mb-16 md:mb-20 text-left flex flex-col items-start w-full">
            <div className="max-w-none md:max-w-3xl w-full">
              <RichText
                ...
                className="[&_h2]:text-xl md:[&_h2]:type-headline-1 [&_h2]:text-black [&_h2]:tracking-tight [&_h2]:!whitespace-nowrap md:[&_h2]:!whitespace-normal [&_h3]:text-xl md:[&_h3]:type-headline-1 [&_h3]:text-black [&_h3]:font-bold [&_h3]:mb-4 [&_p]:type-body-lg [&_p]:text-type-secondary [&_p]:max-w-2xl [&_p]:mt-6"
              />
