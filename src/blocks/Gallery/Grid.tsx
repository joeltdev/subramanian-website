        ...
        <div className="mb-16 md:mb-20">
          <div className="max-w-3xl">
            <RichText 
              data={intro} 
              enableGutter={false} 
              className="[&_h2]:type-display-lg [&_h2]:text-type-heading [&_h2]:tracking-tight [&_h3]:type-headline-2 [&_h3]:text-type-heading [&_h3]:tracking-widest [&_h3]:uppercase [&_h3]:mb-4 [&_p]:type-title-lg [&_p]:text-type-secondary [&_p]:max-w-2xl"
            />
