    ...
    <section ref={sectionRef} className="py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="md:grid md:grid-cols-2 md:gap-16 lg:gap-32 md:items-stretch space-y-12 md:space-y-0">
          <motion.div
            className="flex min-h-0 flex-col items-start md:h-full"
          ...
          >
            <div className="w-full mb-16 md:mb-20">
                ...
                <div className="text-left flex flex-col items-start w-full">
                  <div className="max-w-none md:max-w-3xl w-full">
                    <RichText
                      ...
                      className="[&_h2]:!text-3xl md:[&_h2]:type-display-lg [&_h2]:text-type-heading [&_h2]:tracking-tight [&_h2]:!whitespace-nowrap md:[&_h2]:!whitespace-normal [&_h3]:text-lg md:[&_h3]:type-headline-1 [&_h3]:text-type-heading [&_h3]:font-bold [&_h3]:mb-4 [&_p]:type-title-md [&_p]:text-type-secondary [&_p]:max-w-2xl [&_p]:mt-6 md:[&_p]:mt-0"
                    />
              ...
              {showSupportLine && (
                <p className={cn("type-body-lg text-type-secondary w-full", intro ? "mt-8 md:mt-10" : "")}>
                  {asLink ? (
                    <>
