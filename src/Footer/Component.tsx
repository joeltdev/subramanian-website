...
const socialIcons: Record<string, React.ReactNode> = {
  twitter: (
    <svg className="size-[22px] md:size-[26px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path
        fill="currentColor"
    ...
    <footer data-section-theme="dark" className="bg-background text-foreground border-t border-border">
      <div className="mx-auto max-w-7xl px-6 md:px-8 py-16 md:py-16">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <Link href="/" aria-label="go home" className="block size-fit">
              {typeof logo === 'object' && logo && (logo as Media).url ? (
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  className="h-10 md:h-12 w-auto transition-opacity invert"
                />
              ) : (
          ...
          <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-end gap-6 w-full md:w-auto">
